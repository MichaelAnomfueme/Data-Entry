...
def generate_password(length: int, include_alphabet: str, include_number: str,
                      include_punctuation: str, alphabet_case: str) -> None:
    """
...
def option(length: int, include_alphabet: str, include_number: str,
           include_punctuation: str, alphabet_case: str) -> None:
    """
